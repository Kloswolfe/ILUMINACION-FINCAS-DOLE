      ...
      <div 
        ...
        className={`bg-white p-4 rounded-xl border transition-all duration-200 flex flex-col justify-between ${
          hasEditedDialogue 
            ...
            : 'border-amber-300 ring-1 ring-amber-300/40 bg-amber-50/10 shadow-xs'
        }`}
      >
        <div>
          ...
          <div className="flex items-center justify-between gap-2 mb-1.5">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              {hasEditedDialogue ? (
                ...
                <span 
                  className="px-2 py-0.5 rounded text-[10px] font-extrabold bg-amber-100 text-amber-900 border border-amber-300 flex items-center gap-1 animate-pulse"
          ...
          <div className={`mt-3 p-3 rounded-xl border space-y-2 transition-all ${
            ...
            <textarea
              ...
              className={`w-full text-base font-bold text-slate-900 bg-white rounded-lg p-3 placeholder:text-slate-400 placeholder:font-normal placeholder:text-xs focus:outline-none focus:ring-2 focus:ring-blue-600/30 focus:border-blue-600 resize-none transition-all shadow-2xs leading-relaxed border ${
                hasEditedDialogue ? 'border-slate-300' : 'border-amber-300 focus:border-amber-500'
              }`}
            />

            {!hasEditedDialogue && (
              <p className="text-[11px] text-amber-800 font-semibold flex items-center gap-1 pt-0.5">
          ...
          <div className="flex items-center gap-1.5 text-xs font-medium">
            {hasEditedDialogue ? (
              ...
              <>
                ...
                <span className="text-[11px] text-amber-800 font-bold">Omitida del PDF (Sin editar)</span>
              </>
            )}
          </div>
