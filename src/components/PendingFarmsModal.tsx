...
export function PendingFarmsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto animate-in fade-in duration-150">
      ...
      >
        {/* Encabezado */}
        <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between shrink-0 bg-gradient-to-r from-amber-500/10 via-white to-white">
        ...
        <div className="px-6 py-3 bg-amber-50/80 border-b border-amber-200/70 flex flex-wrap items-center justify-between gap-3 text-xs">
            ...
            <div className="space-y-4">
              ...
              {pendingMaps.map((map) => {
                ...
                return (
                  <div
                    key={map.id}
                    className="p-4 rounded-xl border-2 border-amber-200 bg-amber-50/30 hover:bg-amber-50/50 transition-all space-y-3"
                  >
